...
export const initReservesByHelper = async (
  ...
  for (let i = 0; i < reserveSymbols.length; i++) {
    ...
    initInputParams.push({
      ...
      aTokenName: `Zeebu ${aTokenNamePrefix} ${reserveSymbols[i]}`,
      aTokenSymbol: `z${symbolPrefix}${reserveSymbols[i]}`,
      variableDebtTokenName: `Zeebu ${variableDebtTokenNamePrefix} Variable Debt ${reserveSymbols[i]}`,
      variableDebtTokenSymbol: `variableDebt${symbolPrefix}${reserveSymbols[i]}`,
      stableDebtTokenName: `Zeebu ${stableDebtTokenNamePrefix} Stable Debt ${reserveSymbols[i]}`,
