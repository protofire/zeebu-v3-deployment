...
export const ATOKEN_IMPL_ID = `ZToken-${MARKET_NAME}`;
export const DELEGATION_AWARE_ATOKEN_IMPL_ID = `DelegationAwareZToken-${MARKET_NAME}`;
...
export const ATOKEN_PREFIX = `-ZToken-${MARKET_NAME}`;
